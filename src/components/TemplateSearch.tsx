            ...
            <div className={`justify-center pb-16 relative w-full ${selected ? 'hidden' : 'flex'}`}>
                ...
                >
                    <motion.input
                        ...
                        className="rounded-3xl cursor-none text-sm py-2 pl-4 pr-10 w-full bg-[#151515] border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-[#6a7bd1] transition"
                        style={{
