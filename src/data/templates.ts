export const templates = {
    "Scared-Lady": {
        ...
        textBoxes: [
            ...
            { x: 700, y: 750, width: 600, height: 400, fontSize: 100, align: "center" }
        ]
    },
    ...
    "Trojan-Horse": {
        image: "/temp4.png",
        textBoxes: [
            { x: 2450, y: 2600, width: 900, height: 200, fontSize: 150, align: "center" },
            { x: 2000, y: 2400, width: 900, height: 200, fontSize: 150, align: "center" },
            { x: 590, y: 1900, width: 1000, height: 200, fontSize: 200, align: "center" },
            { x: 1200, y: 1000, width: 800, height: 200, fontSize: 200, align: "center" },
            { x: 2100, y: 400, width: 800, height: 200, fontSize: 300, align: "center" }
        ]
    },
    ...
    "distracted-boyfriend": {
        image: "/temp8.jpg",
        textBoxes: [
            { x: 80, y: 550, width: 520, height: 150, fontSize: 80, align: "center" },
            { x: 560, y: 400, width: 400, height: 100, fontSize: 60, align: "center" },
            { x: 800, y: 500, width: 400, height: 200, fontSize: 70, align: "center" }
        ]
    },
};